...
app.get("/places", async (req, res) => {
  ...
  // res.status(500).json(); // uncomment to see error capture and comment the below code
...
app.put("/user-places", async (req, res) => {
  ...
  // console.log("placeId:",placeId,"req:",req.body.placeId,"only req:".req);
  ...
  //   console.log('userPlacesData:', userPlacesData);
